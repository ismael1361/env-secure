...
abstract class DataEncoder {
	...
	protected encodeSet(v: Set<unknown>): void {
		this.encodeArray(Array.from(v));
	}

	// object/map
	protected abstract encodeObject(_: { [key: string]: unknown }): void;
	protected encodeMap(v: Map<unknown, unknown>): void {
		this.encodeObject(Object.fromEntries(v));
	}
}
...
abstract class AbstractBytesReader implements BytesReader {
	...
	readUint(width: number, bigEndian?: boolean): number {
		switch (width) {
			...
			case 2:
				return this.readDataView(2).getUint16(0, !bigEndian);
			case 4:
				return this.readDataView(4).getUint32(0, !bigEndian);
		}
	...
	readUint24(bigEndian?: boolean): number {
		return this.readUint(3, bigEndian);
	}
	readUint32(bigEndian?: boolean): number {
		return this.readDataView(4).getUint32(0, !bigEndian);
	}
	readUint40(bigEndian?: boolean): number {
		return this.readUint(5, bigEndian);
	}
	readUint48(bigEndian?: boolean): number {
		return this.readUint(6, bigEndian);
	}
	readUint56(bigEndian?: boolean): number {
		return this.readUint(7, bigEndian);
	}
	readUint64(bigEndian?: boolean): number {
		return this.readUint(8, bigEndian);
	}
}
...
abstract class AbstractBytesWriter implements BytesWriter {
	...
	writeUint16(value: number, bigEndian?: boolean): void {
		return this.writeUint(value, 2, bigEndian);
	}
	writeUint24(value: number, bigEndian?: boolean): void {
		return this.writeUint(value, 3, bigEndian);
	}
	writeUint32(value: number, bigEndian?: boolean): void {
		return this.writeUint(value, 4, bigEndian);
	}
	writeUint40(value: number, bigEndian?: boolean): void {
		return this.writeUint(value, 5, bigEndian);
	}
	writeUint48(value: number, bigEndian?: boolean): void {
		return this.writeUint(value, 6, bigEndian);
	}
	writeUint56(value: number, bigEndian?: boolean): void {
		return this.writeUint(value, 7, bigEndian);
	}
	writeUint64(value: number, bigEndian?: boolean): void {
		return this.writeUint(value, 8, bigEndian);
	}
}
...
export class YajbeEncoder extends DataEncoder {
	...
	protected encodeNull(): void {
		this.writer.writeUint8(0);
	}
	protected encodeUndefined(): void {
		this.writer.writeUint8(0);
	}
	protected encodeTrue(): void {
		this.writer.writeUint8(0b11);
	}
	protected encodeFalse(): void {
		this.writer.writeUint8(0b10);
	}
}
...
export class YajbeDecoder {
		...
		while (true) {
			...
			if ((head & 0b11_000000) === 0b11_000000) {
				...
				switch (head) {
					...
					// enum string
					case 0b00001001:
						return this.decodeEnumString(head);
					case 0b00001010:
						return this.decodeEnumString(head);
					case 0b00001011:
						return this.decodeEnumString(head);
					default:
						throw new Error("unsupported item head " + head.toString(2));
				}
	...
	private decodeFloat(head: number): number {
		switch (head & 0b11) {
			case 0b00:
				return this.buffer.readFloat16();
			case 0b01:
				return this.buffer.readFloat32();
			case 0b10:
				return this.buffer.readFloat64();
			case 0b11:
				throw new Error("decode bigdecimal");
		}
		return 0;
	}
...
export class FieldNameReader {
	...
	decodeString(): string {
		...
		switch ((head >> 5) & 0b111) {
			case 0b100:
				return this.readFullFieldName(head);
			case 0b101:
				return this.readIndexedFieldName(head);
			case 0b110:
				return this.readPrefix(head);
			case 0b111:
				return this.readPrefixSuffix(head);
			default:
				throw new Error("unexpected head: " + head.toString(2));
		}
	}
